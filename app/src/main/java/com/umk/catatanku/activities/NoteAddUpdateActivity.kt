...
import com.umk.catatanku.databinding.ActivityNoteAddUpdateBinding
import com.umk.catatanku.helper.DateHelper
...
import com.umk.catatanku.viewmodel.NoteAddUpdateViewModel
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        if (isEdit) {
            menuInflater.inflate(R.menu.menu_add_update_note, menu)
        }
